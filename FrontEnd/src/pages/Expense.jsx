    ...
    <div className=' bg-[#d9d9d9]'>
      <div className='flex items-center justify-between p-[20px]'>
        ...
        <div className='relative'>
          <Link to='/addexpense'>
            <button className='bg-[#1e1e1e] text-white p-[10px] cursor-pointer rounded mr-[15px]'>Add Expense</button>
          </Link>
          <button className='bg-[#1e1e1e] text-white p-[10px] cursor-pointer rounded ' onClick={handleShowReport}>Expense Chart</button>
        </div>
        {showReport && (
