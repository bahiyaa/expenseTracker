...
function useMouseTracker() {
  const svgRef = useSvgRef();
  const [mousePosition, setMousePosition] = React48.useState(null);
  React48.useEffect(() => {
    const element = svgRef.current;
    if (element === null) {
      return () => {
...
function ChartsAxisTooltipContent(props) {
  ...
  const relevantSeries = React52.useMemo(() => {
    const rep = [];
  ...
  const relevantAxis = React52.useMemo(() => {
...
function LegendPerItem(props) {
  ...
  const theme = useTheme();
  const drawingArea = useDrawingArea();
  const labelStyle = React57.useMemo(
  ...
  const padding = React57.useMemo(() => getStandardizedPadding(paddingProps), [paddingProps]);
  const getItemSpace = React57.useCallback((label, inStyle = {}) => {
  ...
  const [itemsWithPosition, legendWidth, legendHeight] = React57.useMemo(() => legendItemPlacements(itemsToDisplay, getItemSpace, labelStyle, direction, availableWidth, availableHeight, itemGap), [itemsToDisplay, getItemSpace, labelStyle, direction, availableWidth, availableHeight, itemGap]);
  const gapX = React57.useMemo(() => {
...
true ? DefaultChartsLegend.propTypes = {
  ...
  seriesToDisplay: import_prop_types14.default.arrayOf(import_prop_types14.default.shape({
    ...
    itemId: import_prop_types14.default.oneOfType([import_prop_types14.default.number, import_prop_types14.default.string]),
    label: import_prop_types14.default.string.isRequired,
    maxValue: import_prop_types14.default.oneOfType([import_prop_types14.default.instanceOf(Date), import_prop_types14.default.number]),
    minValue: import_prop_types14.default.oneOfType([import_prop_types14.default.instanceOf(Date), import_prop_types14.default.number]),
...
function ContinuousColorLegend(props) {
  ...
  return (0, import_jsx_runtime28.jsxs)(React61.Fragment, {
...
function ChartsAxisHighlight(props) {
  ...
  return (0, import_jsx_runtime30.jsxs)(React63.Fragment, {
...
true ? PieArc.propTypes = {
  ...
  highlightScope: import_prop_types19.default.shape({
    fade: import_prop_types19.default.oneOf(["global", "none", "series"]),
    faded: import_prop_types19.default.oneOf(["global", "none", "series"]),
    highlight: import_prop_types19.default.oneOf(["item", "none", "series"]),
...
function useTransformData(series) {
  ...
  const dataWithHighlight = React66.useMemo(() => data.map((item, itemIndex) => {
    const currentItem = {
      seriesId,
      dataIndex: itemIndex
    };
...
true ? PieArcPlot.propTypes = {
   ...
   */
  arcLabelRadius: import_prop_types20.default.number,
  /**
  ...
  data: import_prop_types20.default.arrayOf(import_prop_types20.default.shape({
    ...
    formattedValue: import_prop_types20.default.string.isRequired,
    ...
    label: import_prop_types20.default.oneOfType([import_prop_types20.default.func, import_prop_types20.default.string]),
    padAngle: import_prop_types20.default.number.isRequired,
...
true ? PieArcLabel.propTypes = {
  ...
  formattedArcLabel: import_prop_types21.default.string,
...
true ? PieArcLabelPlot.propTypes = {
   ...
   */
  arcLabel: import_prop_types22.default.oneOfType([import_prop_types22.default.oneOf(["formattedValue", "label", "value"]), import_prop_types22.default.func]),
  /**
   * The minimal angle required to display the arc label.
   * @default 0
   */
  arcLabelMinAngle: import_prop_types22.default.number,
  /**
   * The radius between circle center and the arc label in px.
   * @default (innerRadius - outerRadius) / 2
   */
...
function PiePlot(props) {
  ...
  const {
    ...
    width,
    height
  } = React70.useContext(DrawingContext);
...
var PieChart = React74.forwardRef(function PieChart2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPieChart"
  });
